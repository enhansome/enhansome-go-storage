...
A curated list of awesome Go storage projects and libraries. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,035 | 🐛 215 | 🌐 Go | 📅 2026-08-21.
...
* [rclone](https://github.com/ncw/rclone) ⭐ 59,329 | 🐛 1,248 | 🌐 Go | 📅 2026-08-21 - "rsync for cloud storage" - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfile…
* [rook](https://github.com/rook/rook) ⭐ 13,607 | 🐛 145 | 🌐 Go | 📅 2026-08-21 - Open, Cloud Native, and Universal Distributed Storage.
* [perkeep](https://github.com/perkeep/perkeep) ⭐ 7,227 | 🐛 413 | 🌐 Go | 📅 2026-02-01 - Perkeep is your personal storage system for life: a way of storing, syncing, sharing, modelling and backing up content.
* [storj](https://github.com/storj/storj) ⭐ 3,277 | 🐛 360 | 🌐 Go | 📅 2026-08-21 - Decentralized cloud object storage that is affordable, easy to use, private, and secure.
...
* [etcd](https://github.com/coreos/etcd) ⭐ 52,158 | 🐛 322 | 🌐 Go | 📅 2026-08-20 - Distributed reliable key-value store for the most critical data of a distributed system.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,038 | 🐛 1,414 | 🌐 Go | 📅 2026-08-22 - Distributed consistent replicated key-value store for service discovery and configuration.
* [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,758 | 🐛 70 | 🌐 Go | 📅 2026-08-22 - BadgerDB is an embeddable, persistent, simple and fast key-value (KV) database written in pure Go. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
* [IceFireDB](https://github.com/IceFireDB/IceFireDB) ⭐ 1,154 | 🐛 6 | 🌐 Go | 📅 2026-08-21 - Distributed disk storage database using the Raft and Redis protocols.
...
* [git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,436 | 🐛 483 | 🌐 Go | 📅 2026-08-19 - Git extension for versioning large files.
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,352 | 🐛 198 | 🌐 Go | 📅 2026-08-21 - A distributed POSIX file system built on top of Redis and S3.
* [fsnotify](https://github.com/fsnotify/fsnotify) ⭐ 10,769 | 🐛 41 | 🌐 Go | 📅 2026-05-11 - Cross-platform file system notifications for Go.
* [afero](https://github.com/spf13/afero) ⭐ 6,691 | 🐛 128 | 🌐 Go | 📅 2026-08-14 - A FileSystem Abstraction System for Go
...
* [gcsfuse](https://github.com/GoogleCloudPlatform/gcsfuse) ⭐ 2,298 | 🐛 277 | 🌐 Go | 📅 2026-08-22 - A user-space file system for interacting with Google Cloud Storage.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,412 | 🐛 8,321 | 🌐 Go | 📅 2026-08-07 - A Scalable, Geo-Replicated, Transactional Datastore
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,257 | 🐛 709 | 🌐 Go | 📅 2026-08-23 - A MySQL-compatible database with Git-style version control. The first SQL database you can branch and merge.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,580 | 🐛 778 | 🌐 Go | 📅 2026-08-22 - Time series database designed for monitoring, compatible with PromQL (from Promethueus) and InfluxQL (from Influxdb).
* [bolt](https://github.com/boltdb/bolt) ⚠️ Archived - A low-level key/value database for Go. This original version by Ben Johnson has been marked as unmaintained and forked by [etcd-io bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,696 | 🐛 31 | 🌐 Go | 📅 2026-08-21.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,984 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - A [Zanzibar](https://research.google/pubs/pub48190/)-inspired database that stores, computes, and validates application permissions with support for multiple database backends.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,323 | 🐛 111 | 🌐 Go | 📅 2024-05-14 - An implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 39,350 | 🐛 403 | 🌐 C++ | 📅 2026-03-11 key/value database in the Go.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,844 | 🐛 489 | 🌐 Go | 📅 2026-07-05 - Database migration handling in Golang support MySQL, PostgreSQL, Cassandra, and SQLite.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,240 | 🐛 1,087 | 🌐 Go | 📅 2026-08-23 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
* [usql](https://github.com/xo/usql) ⭐ 10,086 | 🐛 118 | 🌐 Go | 📅 2026-06-19 - universal command-line interface for SQL databases
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,484 | 🐛 55 | 🌐 Go | 📅 2026-07-26 - A web-based PostgreSQL database browser
...
* Relational Databases
  ...
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,221 | 🐛 159 | 🌐 C | 📅 2026-08-17 - SQLite3 driver for go that using database/sql.
...
* NoSQL Databases
  * [redis](https://github.com/go-redis/redis) ⭐ 22,215 | 🐛 65 | 🌐 Go | 📅 2026-08-23 - Redis client for Golang
...
* Search and Analytic Databases
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,184 | 🐛 299 | 🌐 Go | 📅 2026-08-21 - A modern text indexing library for go.
