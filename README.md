...
A curated list of awesome Go storage projects and libraries. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,319 | 🐛 217 | 🌐 Go | 📅 2026-08-26.
...
* [rclone](https://github.com/ncw/rclone) ⭐ 59,402 | 🐛 1,250 | 🌐 Go | 📅 2026-08-26 - "rsync for cloud storage" - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfile…
* [rook](https://github.com/rook/rook) ⭐ 13,615 | 🐛 136 | 🌐 Go | 📅 2026-08-26 - Open, Cloud Native, and Universal Distributed Storage.
...
* [storj](https://github.com/storj/storj) ⭐ 3,275 | 🐛 360 | 🌐 Go | 📅 2026-08-26 - Decentralized cloud object storage that is affordable, easy to use, private, and secure.
* [s3git](https://github.com/s3git/s3git) ⭐ 1,461 | 🐛 20 | 🌐 Go | 📅 2016-08-02 - Git for Cloud Storage. Distributed Version Control for Data.
* [longhorn](https://github.com/rancher/longhorn) ⭐ 0 | 🐛 1 | 🌐 Shell | 📅 2026-08-26 - Longhorn is an open source persistent block storage server delivered via containers.

## Key-Value Store

*Key-Value Store implemented in Go.*

* [etcd](https://github.com/coreos/etcd) ⭐ 52,177 | 🐛 327 | 🌐 Go | 📅 2026-08-26 - Distributed reliable key-value store for the most critical data of a distributed system.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,043 | 🐛 1,421 | 🌐 Go | 📅 2026-08-26 - Distributed consistent replicated key-value store for service discovery and configuration.
* [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,761 | 🐛 69 | 🌐 Go | 📅 2026-08-22 - BadgerDB is an embeddable, persistent, simple and fast key-value (KV) database written in pure Go. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,885 | 🐛 7 | 🌐 Go | 📅 2026-02-10 - A fast, stable and embedded k-v database in pure Golang, supports string, list, hash, set, sorted set.
...
* [git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,444 | 🐛 484 | 🌐 Go | 📅 2026-08-26 - Git extension for versioning large files.
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,358 | 🐛 198 | 🌐 Go | 📅 2026-08-26 - A distributed POSIX file system built on top of Redis and S3.
...
* [gcsfuse](https://github.com/GoogleCloudPlatform/gcsfuse) ⭐ 2,302 | 🐛 281 | 🌐 Go | 📅 2026-08-26 - A user-space file system for interacting with Google Cloud Storage.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,834 | 🐛 887 | 🌐 Go | 📅 2026-08-26 - Monitoring system and time series database.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,415 | 🐛 8,313 | 🌐 Go | 📅 2026-08-07 - A Scalable, Geo-Replicated, Transactional Datastore
* [influxdb](https://github.com/influxdb/influxdb) ⭐ 31,720 | 🐛 2,151 | 🌐 Rust | 📅 2026-08-25 - Scalable datastore for metrics, events, and real-time analytics
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,276 | 🐛 707 | 🌐 Go | 📅 2026-08-26 - A MySQL-compatible database with Git-style version control. The first SQL database you can branch and merge.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,596 | 🐛 786 | 🌐 Go | 📅 2026-08-26 - Time series database designed for monitoring, compatible with PromQL (from Promethueus) and InfluxQL (from Influxdb).
* [bolt](https://github.com/boltdb/bolt) ⚠️ Archived - A low-level key/value database for Go. This original version by Ben Johnson has been marked as unmaintained and forked by [etcd-io bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,705 | 🐛 30 | 🌐 Go | 📅 2026-08-26.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 9,023 | 🐛 104 | 🌐 Go | 📅 2026-08-24 - Database with built-in cryptographic proof and verification. Can operate as a key-value store or as relational database (SQL).
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,990 | 🐛 149 | 🌐 Go | 📅 2026-08-24 - A [Zanzibar](https://research.google/pubs/pub48190/)-inspired database that stores, computes, and validates application permissions with support for multiple database backends.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,325 | 🐛 111 | 🌐 Go | 📅 2024-05-14 - An implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 39,364 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 key/value database in the Go.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,853 | 🐛 489 | 🌐 Go | 📅 2026-07-05 - Database migration handling in Golang support MySQL, PostgreSQL, Cassandra, and SQLite.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,258 | 🐛 1,093 | 🌐 Go | 📅 2026-08-26 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* Relational Databases
  ...
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,227 | 🐛 159 | 🌐 C | 📅 2026-08-17 - SQLite3 driver for go that using database/sql.
...
* NoSQL Databases
  * [redis](https://github.com/go-redis/redis) ⭐ 22,220 | 🐛 66 | 🌐 Go | 📅 2026-08-26 - Redis client for Golang
  ...
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,538 | 🐛 19 | 🌐 Go | 📅 2026-08-26 - The Go driver for MongoDB
...
* Search and Analytic Databases
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,187 | 🐛 297 | 🌐 Go | 📅 2026-08-26 - A modern text indexing library for go.
...
* Multiple Backends
  ...
  * [Fiber Storage](https://github.com/gofiber/storage) ⭐ 335 | 🐛 4 | 🌐 Go | 📅 2026-08-26 - Premade storage drivers that implement the [Storage](https://github.com/gofiber/storage/blob/main/storage.go) ⭐ 335 | 🐛 4 | 🌐 Go | 📅 2026-08-26 interface.
