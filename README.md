...
A curated list of awesome Go storage projects and libraries. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,714 | 🐛 221 | 🌐 Go | 📅 2026-08-30.
...
* [rclone](https://github.com/ncw/rclone) ⭐ 59,458 | 🐛 1,244 | 🌐 Go | 📅 2026-08-30 - "rsync for cloud storage" - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfile…
* [rook](https://github.com/rook/rook) ⭐ 13,619 | 🐛 127 | 🌐 Go | 📅 2026-08-27 - Open, Cloud Native, and Universal Distributed Storage.
* [perkeep](https://github.com/perkeep/perkeep) ⭐ 7,234 | 🐛 413 | 🌐 Go | 📅 2026-02-01 - Perkeep is your personal storage system for life: a way of storing, syncing, sharing, modelling and backing up content.
...
* [etcd](https://github.com/coreos/etcd) ⭐ 52,207 | 🐛 331 | 🌐 Go | 📅 2026-08-27 - Distributed reliable key-value store for the most critical data of a distributed system.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,052 | 🐛 1,420 | 🌐 Go | 📅 2026-08-28 - Distributed consistent replicated key-value store for service discovery and configuration.
* [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,763 | 🐛 68 | 🌐 Go | 📅 2026-08-30 - BadgerDB is an embeddable, persistent, simple and fast key-value (KV) database written in pure Go. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
* [git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,456 | 🐛 481 | 🌐 Go | 📅 2026-08-27 - Git extension for versioning large files.
...
* [gcsfuse](https://github.com/GoogleCloudPlatform/gcsfuse) ⭐ 2,304 | 🐛 285 | 🌐 Go | 📅 2026-08-30 - A user-space file system for interacting with Google Cloud Storage.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,433 | 🐛 8,470 | 🌐 Go | 📅 2026-08-26 - A Scalable, Geo-Replicated, Transactional Datastore
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,297 | 🐛 711 | 🌐 Go | 📅 2026-08-28 - A MySQL-compatible database with Git-style version control. The first SQL database you can branch and merge.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,618 | 🐛 783 | 🌐 Go | 📅 2026-08-29 - Time series database designed for monitoring, compatible with PromQL (from Promethueus) and InfluxQL (from Influxdb).
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,719 | 🐛 162 | 🌐 Go | 📅 2026-08-07 - A geolocation DB with spatial index and realtime geofencing.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 7,002 | 🐛 146 | 🌐 Go | 📅 2026-08-28 - A [Zanzibar](https://research.google/pubs/pub48190/)-inspired database that stores, computes, and validates application permissions with support for multiple database backends.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,325 | 🐛 111 | 🌐 Go | 📅 2024-05-14 - An implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 39,369 | 🐛 404 | 🌐 C++ | 📅 2026-03-11 key/value database in the Go.
...
* [pREST](https://github.com/nuveo/prest) ⭐ 4,612 | 🐛 153 | 🌐 Go | 📅 2026-08-28 - Serve a RESTful API from any PostgreSQL database.
...
* [frostdb](https://github.com/polarsignals/frostdb/) ⭐ 1,544 | 🐛 14 | 🌐 Go | 📅 2026-08-29 - Embeddable column database written in Go.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,870 | 🐛 489 | 🌐 Go | 📅 2026-08-29 - Database migration handling in Golang support MySQL, PostgreSQL, Cassandra, and SQLite.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,279 | 🐛 1,091 | 🌐 Go | 📅 2026-08-29 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,992 | 🐛 107 | 🌐 Go | 📅 2026-07-12 - a tool to generate a Go ORM tailored to your database schema. It is a "database-first" ORM as opposed to "code-first", and you must first create your database.
...
* Relational Databases
  ...
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,199 | 🐛 257 | 🌐 Go | 📅 2026-08-24 - PostgreSQL driver supporting features beyond those exposed by database/sql.
  * [pq](https://github.com/lib/pq) ⭐ 9,951 | 🐛 52 | 🌐 Go | 📅 2026-08-20 - Pure Go Postgres driver for database/sql.
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,229 | 🐛 160 | 🌐 C | 📅 2026-08-17 - SQLite3 driver for go that using database/sql.
...
* NoSQL Databases
  * [redis](https://github.com/go-redis/redis) ⭐ 22,225 | 🐛 67 | 🌐 Go | 📅 2026-08-30 - Redis client for Golang
