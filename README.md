...
A curated list of awesome Go storage projects and libraries. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 183,434 | 🐛 224 | 🌐 Go | 📅 2026-09-07.
...
* [rclone](https://github.com/ncw/rclone) ⭐ 59,636 | 🐛 1,270 | 🌐 Go | 📅 2026-09-07 - "rsync for cloud storage" - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfile…
* [rook](https://github.com/rook/rook) ⭐ 13,645 | 🐛 140 | 🌐 Go | 📅 2026-09-07 - Open, Cloud Native, and Universal Distributed Storage.
...
* [storj](https://github.com/storj/storj) ⭐ 3,279 | 🐛 361 | 🌐 Go | 📅 2026-09-04 - Decentralized cloud object storage that is affordable, easy to use, private, and secure.
* [s3git](https://github.com/s3git/s3git) ⭐ 1,460 | 🐛 20 | 🌐 Go | 📅 2016-08-02 - Git for Cloud Storage. Distributed Version Control for Data.
* [longhorn](https://github.com/rancher/longhorn) ⭐ 0 | 🐛 1 | 🌐 Shell | 📅 2026-09-07 - Longhorn is an open source persistent block storage server delivered via containers.

## Key-Value Store

*Key-Value Store implemented in Go.*

* [etcd](https://github.com/coreos/etcd) ⭐ 52,241 | 🐛 348 | 🌐 Go | 📅 2026-09-07 - Distributed reliable key-value store for the most critical data of a distributed system.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,059 | 🐛 1,426 | 🌐 Go | 📅 2026-09-07 - Distributed consistent replicated key-value store for service discovery and configuration.
* [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,758 | 🐛 68 | 🌐 Go | 📅 2026-09-05 - BadgerDB is an embeddable, persistent, simple and fast key-value (KV) database written in pure Go. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
* [git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,476 | 🐛 477 | 🌐 Go | 📅 2026-09-02 - Git extension for versioning large files.
...
* [go-systemd](https://github.com/coreos/go-systemd) ⭐ 2,712 | 🐛 65 | 🌐 Go | 📅 2026-07-23 - Go bindings to systemd socket activation, journal, D-Bus, and unit files.
* [gcsfuse](https://github.com/GoogleCloudPlatform/gcsfuse) ⭐ 2,307 | 🐛 285 | 🌐 Go | 📅 2026-09-07 - A user-space file system for interacting with Google Cloud Storage.
* [svfs](https://github.com/ovh/svfs) ⚠️ Archived - A virtual file system over Openstack Swift built upon fuse.
* [seaweedfs](https://github.com/chrislusf/seaweedfs) ⭐ 37 | 🐛 1 | 🌐 Go | 📅 2026-09-06 - SeaweedFS is a simple and highly scalable distributed file system for small files.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,444 | 🐛 8,467 | 🌐 Go | 📅 2026-09-02 - A Scalable, Geo-Replicated, Transactional Datastore
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,388 | 🐛 648 | 🌐 Go | 📅 2026-09-06 - A MySQL-compatible database with Git-style version control. The first SQL database you can branch and merge.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,676 | 🐛 785 | 🌐 Go | 📅 2026-09-07 - Time series database designed for monitoring, compatible with PromQL (from Promethueus) and InfluxQL (from Influxdb).
* [bolt](https://github.com/boltdb/bolt) ⚠️ Archived - A low-level key/value database for Go. This original version by Ben Johnson has been marked as unmaintained and forked by [etcd-io bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,725 | 🐛 30 | 🌐 Go | 📅 2026-09-07.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,726 | 🐛 163 | 🌐 Go | 📅 2026-09-02 - A geolocation DB with spatial index and realtime geofencing.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 7,029 | 🐛 145 | 🌐 Go | 📅 2026-09-07 - A [Zanzibar](https://research.google/pubs/pub48190/)-inspired database that stores, computes, and validates application permissions with support for multiple database backends.
...
* [pREST](https://github.com/nuveo/prest) ⭐ 4,615 | 🐛 154 | 🌐 Go | 📅 2026-09-04 - Serve a RESTful API from any PostgreSQL database.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,902 | 🐛 490 | 🌐 Go | 📅 2026-09-07 - Database migration handling in Golang support MySQL, PostgreSQL, Cassandra, and SQLite.
...
* [pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,494 | 🐛 56 | 🌐 Go | 📅 2026-07-26 - A web-based PostgreSQL database browser
...
* [go-mysql](https://github.com/siddontang/go-mysql) ⭐ 4,964 | 🐛 156 | 🌐 Go | 📅 2026-09-05 - A go toolset to handle MySQL protocol and replication.
...
* NoSQL Databases
  * [redis](https://github.com/go-redis/redis) ⭐ 22,228 | 🐛 61 | 🌐 Go | 📅 2026-09-06 - Redis client for Golang
  ...
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,540 | 🐛 18 | 🌐 Go | 📅 2026-09-04 - The Go driver for MongoDB
...
* Search and Analytic Databases
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,199 | 🐛 291 | 🌐 Go | 📅 2026-09-03 - A modern text indexing library for go.
...
* Multiple Backends
  ...
  * [Fiber Storage](https://github.com/gofiber/storage) ⭐ 337 | 🐛 3 | 🌐 Go | 📅 2026-09-07 - Premade storage drivers that implement the [Storage](https://github.com/gofiber/storage/blob/main/storage.go) ⭐ 337 | 🐛 3 | 🌐 Go | 📅 2026-09-07 interface.
