...
A curated list of awesome Go storage projects and libraries. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 183,153 | 🐛 223 | 🌐 Go | 📅 2026-09-04.
...
* [rclone](https://github.com/ncw/rclone) ⭐ 59,549 | 🐛 1,257 | 🌐 Go | 📅 2026-09-04 - "rsync for cloud storage" - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfile…
* [rook](https://github.com/rook/rook) ⭐ 13,636 | 🐛 130 | 🌐 Go | 📅 2026-09-03 - Open, Cloud Native, and Universal Distributed Storage.
...
* [etcd](https://github.com/coreos/etcd) ⭐ 52,231 | 🐛 336 | 🌐 Go | 📅 2026-09-04 - Distributed reliable key-value store for the most critical data of a distributed system.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,053 | 🐛 1,421 | 🌐 Go | 📅 2026-09-04 - Distributed consistent replicated key-value store for service discovery and configuration.
* [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,759 | 🐛 68 | 🌐 Go | 📅 2026-09-03 - BadgerDB is an embeddable, persistent, simple and fast key-value (KV) database written in pure Go. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
* [git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,469 | 🐛 477 | 🌐 Go | 📅 2026-09-02 - Git extension for versioning large files.
...
* [gcsfuse](https://github.com/GoogleCloudPlatform/gcsfuse) ⭐ 2,307 | 🐛 284 | 🌐 Go | 📅 2026-09-04 - A user-space file system for interacting with Google Cloud Storage.
...
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,488 | 🐛 6,913 | 🌐 Go | 📅 2026-09-04 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,433 | 🐛 8,383 | 🌐 Go | 📅 2026-09-02 - A Scalable, Geo-Replicated, Transactional Datastore
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,357 | 🐛 662 | 🌐 Go | 📅 2026-09-04 - A MySQL-compatible database with Git-style version control. The first SQL database you can branch and merge.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,657 | 🐛 780 | 🌐 Go | 📅 2026-09-04 - Time series database designed for monitoring, compatible with PromQL (from Promethueus) and InfluxQL (from Influxdb).
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 9,027 | 🐛 110 | 🌐 Go | 📅 2026-09-04 - Database with built-in cryptographic proof and verification. Can operate as a key-value store or as relational database (SQL).
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 7,023 | 🐛 144 | 🌐 Go | 📅 2026-09-04 - A [Zanzibar](https://research.google/pubs/pub48190/)-inspired database that stores, computes, and validates application permissions with support for multiple database backends.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,323 | 🐛 111 | 🌐 Go | 📅 2024-05-14 - An implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 39,378 | 🐛 406 | 🌐 C++ | 📅 2026-03-11 key/value database in the Go.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,897 | 🐛 490 | 🌐 Go | 📅 2026-08-31 - Database migration handling in Golang support MySQL, PostgreSQL, Cassandra, and SQLite.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,294 | 🐛 1,100 | 🌐 Go | 📅 2026-09-04 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) ⭐ 6,992 | 🐛 108 | 🌐 Go | 📅 2026-07-12 - a tool to generate a Go ORM tailored to your database schema. It is a "database-first" ORM as opposed to "code-first", and you must first create your database.
...
* Relational Databases
  ...
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,233 | 🐛 162 | 🌐 C | 📅 2026-08-17 - SQLite3 driver for go that using database/sql.
...
* NoSQL Databases
  * [redis](https://github.com/go-redis/redis) ⭐ 22,226 | 🐛 60 | 🌐 Go | 📅 2026-09-04 - Redis client for Golang
  ...
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,539 | 🐛 16 | 🌐 Go | 📅 2026-09-04 - The Go driver for MongoDB
  ...
  * [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) ⭐ 460 | 🐛 46 | 🌐 Go | 📅 2026-09-04 - Aerospike client in Go language.
...
* Multiple Backends
  ...
  * [Fiber Storage](https://github.com/gofiber/storage) ⭐ 336 | 🐛 10 | 🌐 Go | 📅 2026-09-04 - Premade storage drivers that implement the [Storage](https://github.com/gofiber/storage/blob/main/storage.go) ⭐ 336 | 🐛 10 | 🌐 Go | 📅 2026-09-04 interface.
