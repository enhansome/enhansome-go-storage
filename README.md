...
A curated list of awesome Go storage projects and libraries. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,220 | 🐛 216 | 🌐 Go | 📅 2026-08-25.
...
* [rclone](https://github.com/ncw/rclone) ⭐ 59,388 | 🐛 1,246 | 🌐 Go | 📅 2026-08-25 - "rsync for cloud storage" - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfile…
* [rook](https://github.com/rook/rook) ⭐ 13,614 | 🐛 141 | 🌐 Go | 📅 2026-08-25 - Open, Cloud Native, and Universal Distributed Storage.
...
* [storj](https://github.com/storj/storj) ⭐ 3,277 | 🐛 360 | 🌐 Go | 📅 2026-08-25 - Decentralized cloud object storage that is affordable, easy to use, private, and secure.
* [s3git](https://github.com/s3git/s3git) ⭐ 1,461 | 🐛 20 | 🌐 Go | 📅 2016-08-02 - Git for Cloud Storage. Distributed Version Control for Data.
* [longhorn](https://github.com/rancher/longhorn) ⭐ 0 | 🐛 1 | 🌐 Shell | 📅 2026-08-25 - Longhorn is an open source persistent block storage server delivered via containers.

## Key-Value Store

*Key-Value Store implemented in Go.*

* [etcd](https://github.com/coreos/etcd) ⭐ 52,172 | 🐛 324 | 🌐 Go | 📅 2026-08-24 - Distributed reliable key-value store for the most critical data of a distributed system.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,043 | 🐛 1,416 | 🌐 Go | 📅 2026-08-25 - Distributed consistent replicated key-value store for service discovery and configuration.
* [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,761 | 🐛 70 | 🌐 Go | 📅 2026-08-22 - BadgerDB is an embeddable, persistent, simple and fast key-value (KV) database written in pure Go. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
* [rosedb](https://github.com/roseduan/rosedb) ⭐ 4,884 | 🐛 7 | 🌐 Go | 📅 2026-02-10 - A fast, stable and embedded k-v database in pure Golang, supports string, list, hash, set, sorted set.
...
* [git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,443 | 🐛 483 | 🌐 Go | 📅 2026-08-25 - Git extension for versioning large files.
...
* [fsnotify](https://github.com/fsnotify/fsnotify) ⭐ 10,771 | 🐛 41 | 🌐 Go | 📅 2026-05-11 - Cross-platform file system notifications for Go.
* [afero](https://github.com/spf13/afero) ⭐ 6,692 | 🐛 128 | 🌐 Go | 📅 2026-08-14 - A FileSystem Abstraction System for Go
...
* [gcsfuse](https://github.com/GoogleCloudPlatform/gcsfuse) ⭐ 2,299 | 🐛 282 | 🌐 Go | 📅 2026-08-25 - A user-space file system for interacting with Google Cloud Storage.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,815 | 🐛 904 | 🌐 Go | 📅 2026-08-25 - Monitoring system and time series database.
* [tidb](https://github.com/pingcap/tidb) ⭐ 40,470 | 🐛 6,835 | 🌐 Go | 📅 2026-08-25 - TiDB is a distributed SQL database. Inspired by the design of Google F1.
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,415 | 🐛 8,241 | 🌐 Go | 📅 2026-08-07 - A Scalable, Geo-Replicated, Transactional Datastore
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,265 | 🐛 711 | 🌐 Go | 📅 2026-08-25 - A MySQL-compatible database with Git-style version control. The first SQL database you can branch and merge.
...
* [rqlite](https://github.com/rqlite/rqlite) ⭐ 17,698 | 🐛 83 | 🌐 Go | 📅 2026-08-25 - The lightweight, distributed, relational database built on SQLite.
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,592 | 🐛 781 | 🌐 Go | 📅 2026-08-25 - Time series database designed for monitoring, compatible with PromQL (from Promethueus) and InfluxQL (from Influxdb).
* [bolt](https://github.com/boltdb/bolt) ⚠️ Archived - A low-level key/value database for Go. This original version by Ben Johnson has been marked as unmaintained and forked by [etcd-io bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,701 | 🐛 34 | 🌐 Go | 📅 2026-08-25.
...
* [immudb](https://github.com/codenotary/immudb) ⭐ 9,021 | 🐛 104 | 🌐 Go | 📅 2026-08-24 - Database with built-in cryptographic proof and verification. Can operate as a key-value store or as relational database (SQL).
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,988 | 🐛 150 | 🌐 Go | 📅 2026-08-24 - A [Zanzibar](https://research.google/pubs/pub48190/)-inspired database that stores, computes, and validates application permissions with support for multiple database backends.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,324 | 🐛 111 | 🌐 Go | 📅 2024-05-14 - An implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 39,360 | 🐛 402 | 🌐 C++ | 📅 2026-03-11 key/value database in the Go.
...
* [vitess](https://github.com/youtube/vitess) ⭐ 21,246 | 🐛 1,089 | 🌐 Go | 📅 2026-08-25 - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
* [goqu](https://github.com/doug-martin/goqu) ⭐ 2,670 | 🐛 146 | 🌐 Go | 📅 2024-05-22 - An idiomatic SQL builder and query library.
...
* Relational Databases
  ...
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,225 | 🐛 159 | 🌐 C | 📅 2026-08-17 - SQLite3 driver for go that using database/sql.
...
* NoSQL Databases
  * [redis](https://github.com/go-redis/redis) ⭐ 22,218 | 🐛 66 | 🌐 Go | 📅 2026-08-25 - Redis client for Golang
  * [cayley](https://github.com/google/cayley) ⭐ 15,061 | 🐛 93 | 🌐 Go | 📅 2026-08-17 - A graph database with support for multiple backends.
  * [redigo](https://github.com/gomodule/redigo) ⭐ 9,857 | 🐛 24 | 🌐 Go | 📅 2025-11-02 - Redigo is a Go client for the Redis database.
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,537 | 🐛 18 | 🌐 Go | 📅 2026-08-24 - The Go driver for MongoDB
...
* Search and Analytic Databases
  * [bleve](https://github.com/blevesearch/bleve) ⭐ 11,184 | 🐛 297 | 🌐 Go | 📅 2026-08-24 - A modern text indexing library for go.
...
* Multiple Backends
  ...
  * [Fiber Storage](https://github.com/gofiber/storage) ⭐ 335 | 🐛 4 | 🌐 Go | 📅 2026-08-25 - Premade storage drivers that implement the [Storage](https://github.com/gofiber/storage/blob/main/storage.go) ⭐ 335 | 🐛 4 | 🌐 Go | 📅 2026-08-25 interface.
