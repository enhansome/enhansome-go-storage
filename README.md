...
A curated list of awesome Go storage projects and libraries. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,811 | 🐛 223 | 🌐 Go | 📅 2026-08-31.
...
* [rclone](https://github.com/ncw/rclone) ⭐ 59,480 | 🐛 1,245 | 🌐 Go | 📅 2026-08-31 - "rsync for cloud storage" - Google Drive, Amazon Drive, S3, Dropbox, Backblaze B2, One Drive, Swift, Hubic, Cloudfile…
* [rook](https://github.com/rook/rook) ⭐ 13,623 | 🐛 130 | 🌐 Go | 📅 2026-08-31 - Open, Cloud Native, and Universal Distributed Storage.
* [perkeep](https://github.com/perkeep/perkeep) ⭐ 7,235 | 🐛 413 | 🌐 Go | 📅 2026-02-01 - Perkeep is your personal storage system for life: a way of storing, syncing, sharing, modelling and backing up content.
* [storj](https://github.com/storj/storj) ⭐ 3,275 | 🐛 361 | 🌐 Go | 📅 2026-08-31 - Decentralized cloud object storage that is affordable, easy to use, private, and secure.
* [s3git](https://github.com/s3git/s3git) ⭐ 1,461 | 🐛 20 | 🌐 Go | 📅 2016-08-02 - Git for Cloud Storage. Distributed Version Control for Data.
* [longhorn](https://github.com/rancher/longhorn) ⭐ 0 | 🐛 1 | 🌐 Shell | 📅 2026-08-31 - Longhorn is an open source persistent block storage server delivered via containers.

## Key-Value Store

*Key-Value Store implemented in Go.*

* [etcd](https://github.com/coreos/etcd) ⭐ 52,212 | 🐛 333 | 🌐 Go | 📅 2026-08-31 - Distributed reliable key-value store for the most critical data of a distributed system.
* [consul](https://github.com/hashicorp/consul) ⭐ 30,053 | 🐛 1,419 | 🌐 Go | 📅 2026-08-31 - Distributed consistent replicated key-value store for service discovery and configuration.
* [BadgerDB](https://github.com/dgraph-io/badger) ⭐ 15,762 | 🐛 69 | 🌐 Go | 📅 2026-08-31 - BadgerDB is an embeddable, persistent, simple and fast key-value (KV) database written in pure Go. It's meant to be a performant alternative to non-Go-based key-value stores like RocksDB.
...
* [IceFireDB](https://github.com/IceFireDB/IceFireDB) ⭐ 1,154 | 🐛 8 | 🌐 Go | 📅 2026-08-31 - Distributed disk storage database using the Raft and Redis protocols.
...
* [git-lfs](https://github.com/git-lfs/git-lfs) ⭐ 14,460 | 🐛 478 | 🌐 Go | 📅 2026-08-31 - Git extension for versioning large files.
...
* [fsnotify](https://github.com/fsnotify/fsnotify) ⭐ 10,777 | 🐛 42 | 🌐 Go | 📅 2026-05-11 - Cross-platform file system notifications for Go.
...
* [gcsfuse](https://github.com/GoogleCloudPlatform/gcsfuse) ⭐ 2,305 | 🐛 283 | 🌐 Go | 📅 2026-08-31 - A user-space file system for interacting with Google Cloud Storage.
...
* [prometheus](https://github.com/prometheus/prometheus) ⭐ 65,925 | 🐛 882 | 🌐 Go | 📅 2026-08-31 - Monitoring system and time series database.
...
* [cockroach](https://github.com/cockroachdb/cockroach) ⭐ 32,436 | 🐛 8,353 | 🌐 Go | 📅 2026-08-26 - A Scalable, Geo-Replicated, Transactional Datastore
...
* [dolt](https://github.com/dolthub/dolt) ⭐ 24,308 | 🐛 710 | 🌐 Go | 📅 2026-08-31 - A MySQL-compatible database with Git-style version control. The first SQL database you can branch and merge.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,623 | 🐛 773 | 🌐 Go | 📅 2026-08-31 - Time series database designed for monitoring, compatible with PromQL (from Promethueus) and InfluxQL (from Influxdb).
* [bolt](https://github.com/boltdb/bolt) ⚠️ Archived - A low-level key/value database for Go. This original version by Ben Johnson has been marked as unmaintained and forked by [etcd-io bbolt](https://github.com/etcd-io/bbolt) ⭐ 9,708 | 🐛 31 | 🌐 Go | 📅 2026-08-26.
...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,720 | 🐛 162 | 🌐 Go | 📅 2026-08-07 - A geolocation DB with spatial index and realtime geofencing.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 7,004 | 🐛 145 | 🌐 Go | 📅 2026-08-31 - A [Zanzibar](https://research.google/pubs/pub48190/)-inspired database that stores, computes, and validates application permissions with support for multiple database backends.
* [goleveldb](https://github.com/syndtr/goleveldb) ⭐ 6,324 | 🐛 111 | 🌐 Go | 📅 2024-05-14 - An implementation of the [LevelDB](https://github.com/google/leveldb) ⭐ 39,375 | 🐛 404 | 🌐 C++ | 📅 2026-03-11 key/value database in the Go.
...
* [pREST](https://github.com/nuveo/prest) ⭐ 4,613 | 🐛 153 | 🌐 Go | 📅 2026-08-28 - Serve a RESTful API from any PostgreSQL database.
...
* [frostdb](https://github.com/polarsignals/frostdb/) ⭐ 1,544 | 🐛 18 | 🌐 Go | 📅 2026-08-31 - Embeddable column database written in Go.
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,878 | 🐛 490 | 🌐 Go | 📅 2026-08-29 - Database migration handling in Golang support MySQL, PostgreSQL, Cassandra, and SQLite.
...
* Relational Databases
  ...
  * [pgx](https://github.com/jackc/pgx) ⭐ 14,208 | 🐛 257 | 🌐 Go | 📅 2026-08-24 - PostgreSQL driver supporting features beyond those exposed by database/sql.
  * [pq](https://github.com/lib/pq) ⭐ 9,951 | 🐛 52 | 🌐 Go | 📅 2026-08-20 - Pure Go Postgres driver for database/sql.
  * [go-sqlite3](https://github.com/mattn/go-sqlite3) ⭐ 9,230 | 🐛 161 | 🌐 C | 📅 2026-08-17 - SQLite3 driver for go that using database/sql.
...
* NoSQL Databases
  * [redis](https://github.com/go-redis/redis) ⭐ 22,226 | 🐛 65 | 🌐 Go | 📅 2026-08-31 - Redis client for Golang
  ...
  * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,538 | 🐛 21 | 🌐 Go | 📅 2026-08-31 - The Go driver for MongoDB
...
* Multiple Backends
  ...
  * [Fiber Storage](https://github.com/gofiber/storage) ⭐ 336 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - Premade storage drivers that implement the [Storage](https://github.com/gofiber/storage/blob/main/storage.go) ⭐ 336 | 🐛 2 | 🌐 Go | 📅 2026-08-31 interface.
